...
\begin{center}
  \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    Esquema&2.1&2.2&2.3&2.4&2.5\\
    \hline
    Livre de Exposição de Chave&X&\ok&X&\ok&\ok\\
    \hline
    Ocultação de Mensagem&\ok&X&\ok&\ok&X\\
    \hline
    Resistência à Falsificação&X&\ok&X&X&\ok\\
    \hline
    Primeira Pré-Imagem&\ok&\ok&X&\ok&X\\
    \hline
  \end{tabular}
\end{center}
